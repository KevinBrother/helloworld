...
CREATE TABLE `asset_values` (
  ...
  FOREIGN KEY (`accountId`) REFERENCES `accounts` (`accountID`) ON DELETE CASCADE ON UPDATE CASCADE,
  FOREIGN KEY (`robotId`) REFERENCES `robots` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  PRIMARY KEY (`id`),
...
CREATE TABLE `button_route_relation` (
  ...
  FOREIGN KEY (`buttonId`) REFERENCES `buttons` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `departments` (
  ...
  `deletedTime` int(11) NOT NULL DEFAULT '0',
  FOREIGN KEY (`tenantID`) REFERENCES `tenants` (`tenantId`) ON DELETE CASCADE ON UPDATE CASCADE,
  FOREIGN KEY (`parentID`) REFERENCES `departments` (`departmentID`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `element_versions` (
  ...
  FOREIGN KEY (`accountID`) REFERENCES `accounts` (`accountID`) ON DELETE CASCADE ON UPDATE CASCADE,
  FOREIGN KEY (`elementID`) REFERENCES `elements` (`elementID`) ON DELETE CASCADE ON UPDATE CASCADE,
  PRIMARY KEY (`id`),
...
CREATE TABLE `jobs` (
  ...
  FOREIGN KEY (`appId`) REFERENCES `apps` (`appId`) ON DELETE CASCADE ON UPDATE CASCADE,
  FOREIGN KEY (`robotId`) REFERENCES `robots` (`robotId`) ON DELETE CASCADE ON UPDATE CASCADE,
  FOREIGN KEY (`accountId`) REFERENCES `accounts` (`accountID`) ON DELETE CASCADE ON UPDATE CASCADE,
  FOREIGN KEY (`tenantId`) REFERENCES `tenants` (`tenantId`) ON DELETE CASCADE ON UPDATE CASCADE,
  FOREIGN KEY (`parentJobId`) REFERENCES `jobs` (`jobId`) ON DELETE CASCADE ON UPDATE CASCADE,
  FOREIGN KEY (`departmentId`) REFERENCES `departments` (`departmentId`) ON DELETE CASCADE ON UPDATE CASCADE,
  PRIMARY KEY (`id`),
...
CREATE TABLE `lib_versions` (
  ...
  `createdTime` bigint(20) DEFAULT '0' COMMENT '创建时间',
  `updatedTime` bigint(20) DEFAULT '0' COMMENT '更新时间',
  FOREIGN KEY (`libId`) REFERENCES `libs` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  FOREIGN KEY (`publisherId`) REFERENCES `accounts` (`accountID`) ON DELETE CASCADE ON UPDATE CASCADE,
  PRIMARY KEY (`id`),
...
CREATE TABLE `operation_mall_apps` (
  ...
  `updatedTime` bigint(20) NOT NULL DEFAULT '0' COMMENT '更新时间',
  `deletedTime` bigint(20) NOT NULL DEFAULT '0' COMMENT '删除时间',
  FOREIGN KEY (`createdByTenantId`) REFERENCES `tenants` (`tenantId`) ON DELETE CASCADE ON UPDATE CASCADE,
  FOREIGN KEY (`createdByAccountId`) REFERENCES `accounts` (`accountID`) ON DELETE CASCADE ON UPDATE CASCADE,
  FOREIGN KEY (`flowId`) REFERENCES `operation_flows` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  FOREIGN KEY (`appVersionId`) REFERENCES `app_versions` (`versionId`) ON DELETE CASCADE ON UPDATE CASCADE,
  FOREIGN KEY (`latestMallReleaseAppId`) REFERENCES `app_versions` (`versionId`) ON DELETE CASCADE ON UPDATE CASCADE,
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `requirement_comments` (
  ...
  FOREIGN KEY (`commenterID`) REFERENCES `accounts` (`accountID`) ON DELETE CASCADE ON UPDATE CASCADE,
  FOREIGN KEY (`recipientID`) REFERENCES `accounts` (`accountID`) ON DELETE CASCADE ON UPDATE CASCADE,
  # todo appId 应该是哪个表的主键 operation_mall_apps | apps？
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `requirements` (
  ...
  FOREIGN KEY (`tenantID`) REFERENCES `tenants` (`tenantId`) ON DELETE CASCADE ON UPDATE CASCADE,
  FOREIGN KEY (`accountID`) REFERENCES `accounts` (`accountID`) ON DELETE CASCADE ON UPDATE CASCADE,
  FOREIGN KEY (`currentAuditorID`) REFERENCES `accounts` (`accountID`) ON DELETE CASCADE ON UPDATE CASCADE,
   # todo appId 应该是哪个表的主键 operation_mall_apps | apps？
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `robot_group_relation` (
  ...
  FOREIGN KEY (`robotId`) REFERENCES `robots` (`robotId`) ON DELETE CASCADE ON UPDATE CASCADE,
  FOREIGN KEY (`groupId`) REFERENCES `robot_groups` (`groupId`) ON DELETE CASCADE ON UPDATE CASCADE,
  PRIMARY KEY (`id`),
...
CREATE TABLE `robots` (
  ...
  FOREIGN KEY (`currentAccountId`) REFERENCES `accounts` (`accountID`) ON DELETE CASCADE ON UPDATE CASCADE,
  FOREIGN KEY (`tenantId`) REFERENCES `tenants` (`tenantId`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `roles` (
  ...
  `updatedTime` int(11) NOT NULL DEFAULT '0',
  `deletedTime` int(11) NOT NULL DEFAULT '0',
  FOREIGN KEY (`parentID`) REFERENCES `roles` (`roleID`) ON DELETE CASCADE ON UPDATE CASCADE,
  FOREIGN KEY (`tenantID`) REFERENCES `tenants` (`tenantId`) ON DELETE CASCADE ON UPDATE CASCADE,
  PRIMARY KEY (`roleID`),
  KEY `ix_tid` (`tenantID`),
  KEY `ix_pid` (`parentID`)
...
CREATE TABLE `task_runner_relation` (
  ...
  FOREIGN KEY (`taskId`) REFERENCES `tasks` (`taskId`) ON DELETE CASCADE ON UPDATE CASCADE,
  FOREIGN KEY (`runnerId`) REFERENCES `robots` (`robotId`) ON DELETE CASCADE ON UPDATE CASCADE,
  PRIMARY KEY (`id`),
...
CREATE TABLE `tasks` (
  ...
  FOREIGN KEY (`parentTaskId`) REFERENCES `tasks` (`taskId`) ON DELETE CASCADE ON UPDATE CASCADE,
  FOREIGN KEY (`sharedFromTaskId`) REFERENCES `tasks` (`taskId`) ON DELETE CASCADE ON UPDATE CASCADE,
  FOREIGN KEY (`userId`) REFERENCES `accounts` (`accountID`) ON DELETE CASCADE ON UPDATE CASCADE,
  FOREIGN KEY (`appId`) REFERENCES `apps` (`appId`) ON DELETE CASCADE ON UPDATE CASCADE,
  PRIMARY KEY (`id`),
...
CREATE TABLE `tenants` (
  ...
  FOREIGN KEY (`parentID`) REFERENCES `tenants` (`tenantID`) ON DELETE CASCADE ON UPDATE CASCADE,
  FOREIGN KEY (`tenantID`) REFERENCES `accounts` (`accountID`) ON DELETE CASCADE ON UPDATE CASCADE,
  PRIMARY KEY (`id`),
