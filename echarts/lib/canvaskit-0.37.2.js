var CanvasKitInit = (() => {
  ...
  return function (CanvasKitInit) {
    ...
    (function (a) {
      ...
      a.Wd.push(function () {
        a.MakeSWCanvasSurface = function (b) {
          ...
          if ((b = a.MakeSurface(d.width, d.height))) b.Od = d;
          return b;
        };
        ...
        a.Surface.prototype.flush = function (b) {
          ...
          this._flush();
          if (this.Od) {
            var d = new Uint8ClampedArray(a.HEAPU8.buffer, this.af, this.Df);
            d = new ImageData(d, this.Ff, this.Bf);
            b
              ...
              : this.Od.getContext('2d').putImageData(d, 0, 0);
          }
        };
    ...
    (function (a) {
      ...
      a.Wd.push(function () {
        ...
        a.deleteContext = function (n) {
          x === ma[n] && (x = null);
          'object' == typeof JSEvents && JSEvents.vg(ma[n].he.canvas);
          ma[n] && ma[n].he.canvas && (ma[n].he.canvas.zf = void 0);
          ma[n] = null;
        };
        a._setTextureCleanup({
          deleteTexture: function (n, q) {
            var v = ha[q];
            v && ma[n].he.deleteTexture(v);
            ha[q] = null;
          }
        });
        ...
        a.Surface.prototype.makeImageFromTexture = function (n, q) {
          a.Pd(this.Nd);
          n = d(n);
          if ((q = this._makeImageFromTexture(this.Nd, n, q))) q.Me = n;
          return q;
        };
        ...
        a.Surface.prototype.updateTextureFromSource = function (n, q, v) {
          if (n.Me) {
            ...
            q = this._makeImageFromTexture(this.Nd, n.Me, D);
            v = n.Md.Ud;
            I = n.Md.ae;
            n.Md.Ud = q.Md.Ud;
            n.Md.ae = q.Md.ae;
    ...
    (function (a) {
      ...
      function D(e) {
        var c = { de: V, count: e.length, colorType: a.ColorType.RGBA_F32 };
        if (e instanceof Float32Array)
          (c.de = v(e, 'HEAPF32')), (c.count = e.length / 4);
        else if (e instanceof Uint32Array)
          (c.de = v(e, 'HEAPU32')), (c.colorType = a.ColorType.RGBA_8888);
      ...
      a.Malloc = function (e, c) {
        ...
        return {
          ...
          toTypedArray: function () {
            ...
            this.se = new e(a.HEAPU8.buffer, g, c);
            this.se._ck = !0;
            return this.se;
          }
        };
      ...
      a.onRuntimeInitialized = function () {
        ...
        a.Canvas.prototype.drawImageRect = function (c, g, l, r, y) {
          ...
          U(g, ka);
          U(l, Pa);
          this._drawImageRect(c, ka, Pa, r, !!y);
        };
        a.Canvas.prototype.drawImageRectCubic = function (c, g, l, r, y, C) {
          a.Pd(this.Nd);
          U(g, ka);
          U(l, Pa);
          this._drawImageRectCubic(c, ka, Pa, r, y, C || null);
        };
        a.Canvas.prototype.drawImageRectOptions = function (c, g, l, r, y, C) {
          a.Pd(this.Nd);
          U(g, ka);
          U(l, Pa);
          this._drawImageRectOptions(c, ka, Pa, r, y, C || null);
        };
        ...
        a.getShadowLocalBounds = function (c, g, l, r, y, C, J) {
          ...
          l = v(l, 'HEAPF32', Yb);
          r = v(r, 'HEAPF32', Zb);
          if (!this._getShadowLocalBounds(c, g, l, r, y, C, ka)) return null;
          g = Ha.toTypedArray();
      ...
      a.M44.invert = function (e) {
        ...
        var oa = c * C - g * y,
          ...
          G = W * e - F * X,
          L = t * e - F * ia,
          ca = oa * L - qa * G + sa * E + ba * B - H * A + k * p,
          da = 1 / ca;
        ...
        e.Wd.push(function () {
          ...
          function y(t) {
            ...
            if (Array.isArray(t.shadows) && t.shadows.length) {
              ...
              for (
                var ia = e._malloc(8 * F.length), oa = ia / 4, qa = 0;
                qa < F.length;
                qa++
              ) {
      ...
      (function () {
        ...
        function r(H) {
          ...
          this.clearRect = function (k, p, A, B) {
            ...
            this.Od.drawRect(a.XYWHRect(k, p, A, B), this.Rd);
            this.Rd.setBlendMode(this.Qd);
          };
          ...
          this.createRadialGradient = function (k, p, A, B, E, G) {
            if (e(arguments)) {
              var L = new oa(k, p, A, B, E, G);
              this.De.push(L);
              return L;
            }
          };
          this.drawImage = function (k) {
            k instanceof C && (k = k.uf());
            var p = this.Qe();
            ...
            this.Od.drawImageRect(k, B, A, p, !1);
            p.dispose();
          };
          this.ellipse = function (k, p, A, B, E, G, L, ca) {
            F(this.Td, k, p, A, B, E, G, L, ca);
          };
          this.Qe = function () {
            var k = this.Rd.copy();
          ...
          this.fillRect = function (k, p, A, B) {
            ...
            G &&
              (this.Od.save(),
              this.te(),
              this.Od.drawRect(a.XYWHRect(k, p, A, B), G),
              this.Od.restore(),
              G.dispose());
            this.Od.drawRect(a.XYWHRect(k, p, A, B), E);
            E.dispose();
          };
          ...
          this.putImageData = function (k, p, A, B, E, G, L) {
            if (e([p, A, B, E, G, L]))
              if (void 0 === B)
                this.Od.writePixels(k.data, k.width, k.height, p, A);
              else if (
                ((B = B || 0),
                (E = E || 0),
                (G = G || k.width),
          ...
          this.resetTransform = function () {
            ...
            this.Od.concat(k);
            this.Vd = this.Od.getTotalMatrix();
          };
          this.restore = function () {
            var k = this.nf.pop();
            if (k) {
              var p = a.Matrix.multiply(this.Vd, a.Matrix.invert(k.Hf));
              this.Td.transform(p);
              this.Rd.delete();
              this.Rd = k.ag;
              this.we = k.Zf;
          ...
          this.te = function () {
            ...
            this.Od.concat(this.Vd);
          };
          this.Ae = function (k) {
            var p = a.multiplyByAlpha(this.Ke, this.le);
            if (!a.getColorComponents(p)[3] || !(this.xe || this.ze || this.ye))
              return null;
            k = k.copy();
            k.setColor(p);
        ...
        function Q(H, k, p, A) {
          ...
          this.addColorStop = function (B, E) {
            ...
            E = g(E);
            var G = this.be.indexOf(B);
            if (-1 !== G) this.ee[G] = E;
            else {
              for (G = 0; G < this.be.length && !(this.be[G] > B); G++);
              this.be.splice(G, 0, B);
        ...
        function oa(H, k, p, A, B, E) {
          ...
          this.addColorStop = function (G, L) {
            ...
            if (-1 !== ca) this.ee[ca] = L;
            else {
              for (ca = 0; ca < this.be.length && !(this.be[ca] > G); ca++);
              this.be.splice(ca, 0, G);
              this.ee.splice(ca, 0, L);
            }
          };
          this.ue = function () {
            var G = new oa(H, k, p, A, B, E);
            G.ee = this.ee.slice();
            G.be = this.be.slice();
            return G;
          };
    ...
    function bc(a) {
      Y(a.Md.Yd.Sd.name + ' instance already deleted');
    }
    var cc = !1;
    function dc() {}
    function ec(a) {
      --a.count.value;
      0 === a.count.value && (a.ae ? a.ge.me(a.ae) : a.Yd.Sd.me(a.Ud));
    }
    function fc(a, b, d) {
      if (b === d) return a;
      if (void 0 === d.je) return null;
      a = fc(a, b, d.je);
      return null === a ? null : d.Kf(a);
    }
    var gc = {},
      hc = [];
    function ic() {
    ...
    var jc = void 0,
      kc = {};
    function lc(a, b) {
      for (void 0 === b && Y('ptr should not be undefined'); a.je; )
        (b = a.Pe(b)), (a = a.je);
      return kc[b];
    }
    function mc(a, b) {
      (b.Yd && b.Ud) || Ob('makeClassHandle requires ptr and ptrType');
      !!b.ge !== !!b.ae &&
    ...
    function qc(a, b, d) {
      w.hasOwnProperty(a)
        ? ((void 0 === d || (void 0 !== w[a].$d && void 0 !== w[a].$d[d])) &&
    ...
    function tc(a, b) {
      if (null === b)
        return this.gf && Y('null is not a valid ' + this.name), 0;
      b.Md || Y('Cannot pass "' + uc(b) + '" as a ' + this.name);
      b.Md.Ud ||
        Y('Cannot pass deleted object as a pointer of type ' + this.name);
      return sc(b.Md.Ud, b.Md.Yd.Sd, this.Sd);
    }
    function vc(a, b) {
      if (null === b) {
        this.gf && Y('null is not a valid ' + this.name);
        if (this.Ue) {
          var d = this.hf();
          null !== a && a.push(this.me, d);
          return d;
        }
        return 0;
      }
      ...
      d = sc(b.Md.Ud, b.Md.Yd.Sd, this.Sd);
      if (this.Ue)
        switch (
          (void 0 === b.Md.ae &&
    ...
    function Ad(a, b) {
      var d = fa(ma),
        f = { Vf: d, attributes: b, version: b.majorVersion, he: a };
    ...
    function Kd(a) {
      ...
      if (b) {
        ...
        'number' == typeof d &&
          (b.Oe[a] = d =
            Z.getUniformLocation(b, b.xf[a] + (0 < d ? '[' + d + ']' : '')));
        return d;
      }
      wd(1282);
    }
    ...
    function Ud(a, b, d, f) {
      ...
      function q(z) {
        var N = z.qe;
        for (z = new Date(new Date(z.re + 1900, 0, 1).getTime()); 0 < N; ) {
          var T = z.getMonth(),
      ...
      v = {
        ...
        '%V': function (z) {
          var N = Math.floor((z.qe + 7 - ((z.ke + 6) % 7)) / 7);
          2 >= (z.ke + 371 - z.qe - 2) % 7 && N++;
          if (N)
            53 == N &&
              ((T = (z.ke + 371 - z.qe) % 7),
              4 == T || (3 == T && Rd(z.re)) || (N = 1));
            ...
            N = 52;
            var T = (z.ke + 7 - z.qe - 1) % 7;
            (4 == T || (5 == T && Rd((z.re % 400) - 1))) && N++;
          }
          return m(N, 2);
        },
        '%w': function (z) {
    ...
    oc.prototype.isAliasOf = function (a) {
      ...
      var b = this.Md.Yd.Sd,
        d = this.Md.Ud,
        f = a.Md.Yd.Sd;
      for (a = a.Md.Ud; b.je; ) (d = b.Pe(d)), (b = b.je);
    ...
    oc.prototype['delete'] = function () {
      this.Md.Ud || bc(this);
      this.Md.Ge && !this.Md.Ne && Y('Object already scheduled for deletion');
      dc(this);
      ec(this.Md);
      this.Md.Ne || ((this.Md.ae = void 0), (this.Md.Ud = void 0));
    };
    ...
    yc.prototype.fromWireType = function (a) {
      function b() {
        return this.Ue
          ? mc(this.Sd.He, { Yd: this.bg, Ud: d, ge: this, ae: a })
          : mc(this.Sd.He, { Yd: this, Ud: a });
      }
      var d = this.Rf(a);
      if (!d) return this.qf(a), null;
      var f = lc(this.Sd, d);
      if (void 0 !== f) {
        if (0 === f.Md.count.value)
          return (f.Md.Ud = d), (f.Md.ae = a), f.clone();
        f = f.clone();
        this.qf(a);
        return f;
      }
      ...
      var h = fc(d, this.Sd, f.Sd);
      return null === h
        ? b.call(this)
        : this.Ue
        ? mc(f.Sd.He, { Yd: f, Ud: h, ge: this, ae: a })
        : mc(f.Sd.He, { Yd: f, Ud: h });
    };
    ...
    var qe = {
      ...
      h: function (a, b, d, f, h, m, u) {
        ...
        Pb([], [a], function (q) {
          ...
          var I = q.Sd.constructor;
          void 0 === I[b]
            ? ((v.Ee = d - 1), (I[b] = v))
            : (pc(I, b, D), (I[b].$d[d - 1] = v));
          Pb([], n, function (M) {
      ...
      z: function (a, b, d, f, h, m) {
        ...
        Pb([], [a], function (n) {
          ...
          void 0 === n.Sd.pe && (n.Sd.pe = []);
          if (void 0 !== n.Sd.pe[b - 1])
            throw new ac(
      ...
      b: function (a, b, d, f, h, m, u, n) {
        ...
        Pb([], [a], function (v) {
          ...
          var M = v.Sd.He,
            z = M[b];
          void 0 === z ||
          (void 0 === z.$d && z.className !== v.name && z.Ee === d - 2)
            ? ((D.Ee = d - 2), (D.className = v.name), (M[b] = D))
            : (pc(M, b, I), (M[b].$d[d - 2] = D));
          Pb([], q, function (N) {
            N = Nc(I, N, v, m, u);
            void 0 === M[b].$d
              ? ((N.Ee = d - 2), (M[b] = N))
      ...
      u: function (a, b, d, f, h, m, u, n, q, v, D, I) {
        d = Tb(d);
        m = Bc(h, m);
        n = Bc(u, n);
        v = Bc(q, v);
        ...
        Pb([a], [b], function (M) {
          M = M[0];
          return [new yc(d, M.Sd, !1, !1, !0, M, f, m, n, v, I)];
        });
      },
      Y: function (a, b) {
        b = Tb(b);
      ...
      E: function (a, b, d, f, h, m) {
        Eb[a] = { name: Tb(b), hf: Bc(d, f), me: Bc(h, m), tf: [] };
      },
      ...
      A: function (a, b) {
        ...
        h = ad((u, n, q, v) => {
          ...
          u = u[n].apply(u, m);
          for (I = 0; I < a - 1; ++I) d[I + 1].Jf && d[I + 1].Jf(m[I]);
          if (!f.Yf) return f.toWireType(q, u);
        });
        return (cd[b] = h);
      },
      I: function (a, b) {
      ...
      ac: function (a, b, d, f, h, m, u, n, q, v) {
      ...
      _b: function (a, b, d, f, h) {
        Z.copyBufferSubData(a, b, d, f, h);
      },
      pa: function (a, b, d, f, h, m, u, n) {
      ...
      wc: function (a, b, d, f, h) {
        Z.rf.drawArraysInstancedBaseInstanceWEBGL(a, b, d, f, h);
      },
      uc: function (a, b) {
      ...
      Cc: function (a, b, d, f, h) {
        Z.drawElementsInstanced(a, b, d, f, h);
      },
      xc: function (a, b, d, f, h, m, u) {
          ...
          if (a >= kd) wd(1281);
            ...
            if (!a.Xe)
              for (b = 0; b < Z.getProgramParameter(a, 35718); ++b)
                a.Xe = Math.max(a.Xe, Z.getActiveUniform(a, b).name.length + 1);
            R[d >> 2] = a.Xe;
          } else if (35722 == b) {
            if (!a.Ve)
              for (b = 0; b < Z.getProgramParameter(a, 35721); ++b)
                a.Ve = Math.max(a.Ve, Z.getActiveAttrib(a, b).name.length + 1);
            R[d >> 2] = a.Ve;
          } else if (35381 == b) {
            if (!a.We)
      ...
      Va: function (a, b, d, f, h, m, u) {
        if (2 <= x.version)
          if (Z.df) Z.readPixels(a, b, d, f, h, m, u);
          else {
            var n = Id(m);
            Z.readPixels(
              a,
      ...
      cb: function (a, b, d, f, h, m, u, n, q) {
        if (2 <= x.version)
          if (Z.Fe) Z.texImage2D(a, b, d, f, h, m, u, n, q);
          else if (q) {
            var v = Id(n);
            Z.texImage2D(
              a,
      ...
      hb: function (a, b, d, f, h, m, u, n, q) {
        if (2 <= x.version)
          if (Z.Fe) Z.texSubImage2D(a, b, d, f, h, m, u, n, q);
          else if (q) {
            var v = Id(n);
            Z.texSubImage2D(
              a,
    ...
    w.___wasm_call_ctors = function () {
      return (w.___wasm_call_ctors = w.asm.fd).apply(null, arguments);
    };
    var Lc = (w._free = function () {
        return (Lc = w._free = w.asm.hd).apply(null, arguments);
      }),
      Gd = (w._malloc = function () {
        return (Gd = w._malloc = w.asm.id).apply(null, arguments);
      }),
      Kc = (w.___getTypeName = function () {
        return (Kc = w.___getTypeName = w.asm.jd).apply(null, arguments);
      });
    w.___embind_register_native_and_builtin_types = function () {
      return (w.___embind_register_native_and_builtin_types = w.asm.kd).apply(
        null,
        arguments
      );
    };
    var re = (w._setThrew = function () {
        return (re = w._setThrew = w.asm.ld).apply(null, arguments);
      }),
      se = (w.stackSave = function () {
        return (se = w.stackSave = w.asm.md).apply(null, arguments);
      }),
      te = (w.stackRestore = function () {
        return (te = w.stackRestore = w.asm.nd).apply(null, arguments);
      });
    w.dynCall_viji = function () {
      return (w.dynCall_viji = w.asm.od).apply(null, arguments);
    };
    w.dynCall_vijiii = function () {
      return (w.dynCall_vijiii = w.asm.pd).apply(null, arguments);
    };
    w.dynCall_viiiiij = function () {
      return (w.dynCall_viiiiij = w.asm.qd).apply(null, arguments);
    };
    w.dynCall_jiiiijiiiii = function () {
      return (w.dynCall_jiiiijiiiii = w.asm.rd).apply(null, arguments);
    };
    w.dynCall_viiij = function () {
      return (w.dynCall_viiij = w.asm.sd).apply(null, arguments);
    };
    w.dynCall_jii = function () {
      return (w.dynCall_jii = w.asm.td).apply(null, arguments);
    };
    w.dynCall_vij = function () {
      return (w.dynCall_vij = w.asm.ud).apply(null, arguments);
    };
    w.dynCall_iiij = function () {
      return (w.dynCall_iiij = w.asm.vd).apply(null, arguments);
    };
    w.dynCall_iiiij = function () {
      return (w.dynCall_iiiij = w.asm.wd).apply(null, arguments);
    };
    w.dynCall_viij = function () {
      return (w.dynCall_viij = w.asm.xd).apply(null, arguments);
    };
    w.dynCall_ji = function () {
      return (w.dynCall_ji = w.asm.yd).apply(null, arguments);
    };
    w.dynCall_iij = function () {
      return (w.dynCall_iij = w.asm.zd).apply(null, arguments);
    };
    ...
    function pe(a, b, d, f, h, m, u, n, q, v) {
      var D = se();
      try {
